...
// A project site on GitHub Pages lives under /<repo>. Unset everywhere else (Vercel, a custom domain, localhost).
// NEXT_PUBLIC_ so lib/replay.ts can prefix its one raw fetch: next/link applies basePath itself, fetch does not.
